...
<div id="content-wrapper">
    ...
    <table class="table table-striped table-hover">
        ...
        <tbody> 
            ...
            <tr> 
                <td> <a href='client-project-phases/id/<?=$project_inf0['project_id']?>/project_cat_id/<?=$project_inf0['project_cat_id']?>'>
                      <?=$project_inf0['project_id']?> </a>
                </td>
                <td> 
                   <a href='client-project-phases/id/<?=$project_inf0['project_id']?>/project_cat_id/<?=$project_inf0['project_cat_id']?>'>
                          <?=$project_inf0['project_name']?> 
                    </a>
                </td>
                <td> 
                     <?=$project_inf0['project_category']?> 
