...
foreach ($open_project_details as $open_project) {
 echo "
        <tr role='row' class='odd'>            
           ...
           <a href='admin-show-client-project-status/id/".$open_project['project_id']."/project_cat_id/".$open_project['project_cat_id']."/com_id/".$open_project['company_id']."'>  ".$open_project['project_id']."
               </a> </span></td>
            <td><span> 
             <a href='admin-show-client-project-status/id/".$open_project['project_id']."/project_cat_id/".$open_project['project_cat_id']."/com_id/".$open_project['company_id']."'>  ".$open_project['project_name']."
                </span></td>
           ...
           <?php 
               if( $open_project['project_status'] == "Running") { 
...
foreach ($project_details as $closed_project) {
 echo "
        <tr role='row' class='odd'>            
           <td><span>
                 <a href='admin-show-client-project-status/id/".$closed_project['project_id']."/project_cat_id/".$closed_project['project_cat_id']."/com_id/".$closed_project['company_id']."'>  ".$closed_project['project_id']."
                  
                        </a> 
               </span></td>
            <td><span> 
               <a href='admin-show-client-project-status/id/".$closed_project['project_id']."/project_cat_id/".$closed_project['project_cat_id']."/com_id/".$closed_project['company_id']."'>  ".$closed_project['project_name']." </a>
                    </span></td>
...
foreach ($project_details as $closed_project) {
 echo "
        <tr role='row' class='odd'>            
           <td><span> <a href='admin-show-client-project-status/id/".$closed_project['project_id']."/project_cat_id/".$closed_project['project_cat_id']."/com_id/".$closed_project['company_id']."'>  ".$closed_project['project_id']." </a> </span></td>
            <td><span><a href='admin-show-client-project-status/id/".$closed_project['project_id']."/project_cat_id/".$closed_project['project_cat_id']."/com_id/".$closed_project['company_id']."'>  ".$closed_project['project_name']." </a> </span></td>
            <td><span> ".$closed_project['project_category']." </span></td>
            <td><span> ".$closed_project['company_name']." </span></td>
           <td><span> ".date('M j, Y', strtotime($closed_project['project_start_date']))." </span></td>
           <td><span> $".$closed_project['project_cost']." </span></td>"
...
foreach ($project_details as $closed_project) {
 echo "
        <tr role='row' class='odd'>            
           <td><span> <a href='admin-show-client-project-status/id/".$closed_project['project_id']."'>  ".$closed_project['project_id']." </a> </span></td>
            <td><span> <a href='admin-show-client-project-status/id/".$closed_project['project_id']."/project_cat_id/".$closed_project['project_cat_id']."/com_id/".$closed_project['company_id']."'>  ".$closed_project['name']." </a> </span></td>
            <td><span> ".$closed_project['project_category']." </span></td>
            <td><span> ".$closed_project['company_name']." </span></td>
           <td><span> ".date('M j, Y', strtotime($closed_project['project_start_date']))." </span></td>
           <td><span> $".$closed_project['project_cost']." </span></td>"
