...
try {
        ...
        if( intval($_POST['client_id']) !== '0' ) { 
            ...
            if ( !file_exists("../prooject-files-custom/$user_directory_name") ) {
                
               mkdir("../prooject-files-custom/$user_directory_name", 0777, true);
            
            }
            
            //making uniq   name
            $file_destination = sprintf("../prooject-files-custom/$user_directory_name/%s.%s",
        ...
        // if team
        else if( intval($_POST['team_id']) !== '0' ) { 
    ...
    if(  $project_file->show_files_custom( $data['question_id'], $data['project_id'] ) ) {
            
        $files = $project_file->show_files_custom( $data['question_id'], $data['project_id'] );
    ...
    $is_save = $project_file->save_custom();
