...
try {
        ...
        if( intval($_POST['client_id']) !== '0' ) { 
            ...
            if ( !file_exists("../project-files-ticket/$user_directory_name") ) {
                
               mkdir("../project-files-ticket/$user_directory_name", 0777, true);
            
            }
            
            //making uniq   name
            $file_destination = sprintf("../project-files-ticket/$user_directory_name/%s.%s",
    ...
    if(  $project_file->show_files_ticket( $data['ticket_id'], $data['web_id'] ) ) {
            
        $files = $project_file->show_files_ticket( $data['ticket_id'], $data['web_id'] );
    ...
    $is_save = $project_file->save_ticket_file();
